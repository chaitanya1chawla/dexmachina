...
project = "dexmachina"  # Change project name
copyright = "2025"  # Update copyright year/holder if needed
author = "MandiZhao"  # Update author name

# version: str = os.environ.get(
#     "PYROKI_VERSION_STR_OVERRIDE", dexmachina.__version__
# )  # Remove this
...
html_theme_options = {
    ...
    # "light_logo": "dexmachina_logo.png",
    # "dark_logo": "dexmachina_logo.png",
}
...
#
html_theme = "furo"
html_title = "dexmachina"  # Update title
...
htmlhelp_basename = "dexmachina_doc"  # Update basename
...
latex_documents = [
    (
        master_doc,
        "dexmachina.tex",  # Update target name
        "dexmachina",  # Update title
        "Mandi Zhao",  # Update author
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "dexmachina", "dexmachina documentation", [author], 1)
...
texinfo_documents = [
    (
        master_doc,
        "dexmachina",  # Update target name
        "dexmachina",  # Update title
        author,
        "dexmachina",  # Update dir menu entry
        "DexMachina: Functional Retargeting for Bimanual Dexterous Manipulation",  # Update description
        "Documentation",
    ),
]
